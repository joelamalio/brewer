package br.com.joelamalio.brewer.thymeleaf.processor;
...
public class ClassForErrorAttributePorcessor extends AbstractAttributeTagProcessor {

	private static final String NOME_ATRIBUTO = "classforerror";
	private static final int PRECEDENCIA = 1000;

	public ClassForErrorAttributePorcessor(String dialectPrefix) {
