package br.com.joelamalio.brewer.storage.s3;
...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "jabrewer";
	...
	public String getUrl(String foto) {
		if (!StringUtils.isEmpty(foto)) {
			return "https://s3-sa-east-1.amazonaws.com/jabrewer/" + foto;
		}
		return null;
	}
	
	private void enviarFoto(String novoNome, MultipartFile arquivo, AccessControlList acl)
			throws IOException {
	...
	private void enviarThumbnail(String novoNome, MultipartFile arquivo, AccessControlList acl)	throws IOException {
		...
		Thumbnails.of(arquivo.getInputStream()).forceSize(40, 68).toOutputStream(os);
